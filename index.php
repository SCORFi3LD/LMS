...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
    <head>
        ...
        <title>Login - Education Center</title>
                    ...
                    <div class="flex flex-col overflow-y-auto md:flex-row">
                        ...
                        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                            <div class="w-full">
                                ...
                                if (isset($_GET["msg"])) {
                                    ?>
                                    <div class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-orange-600 dark:bg-orange-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
                                ...
                                <label class="block mt-4 text-sm">
                                    ...
                                    <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="password" placeholder="Enter your password" type="password"/>
                                </label>
                                <!-- You should use a button here, as the anchor is only used for the example  -->
                                <button type="submit" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="index.html"> Log in </button>
                                <p class="mt-1">
                                    <a class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="create-account.php"> Create account </a>
                                </p>
                            </div>
                        </div>
                    </div>
